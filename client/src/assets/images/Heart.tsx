...
function HeartIcon({ followed, ...rest }: { followed: boolean | undefined }) {
  const svgParams: React.SVGProps<SVGSVGElement> = { ...rest };
  return (
    <svg height={17} viewBox="0 0 18 17" width={18} xmlns="http://www.w3.org/2000/svg" {...svgParams}>
      <path
