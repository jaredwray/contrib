      ...
      <section className="charities-page">
        <Container>
          ...
          <Row className="charities-page-title text-headline">
            <Col xs="8" sm="9">Your charities</Col>
            <Col xs="4" sm="3" className="text-right step-title">Step 2</Col>
          </Row>
          <hr />
          <Row className="pt-3 pt-md-0">
            <Col md="6">
              <div className="text-subhead">Choose your charities</div>
              <div className="text-body pt-0 pt-md-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Consectetur quis eu amet vitae sit sed facilisi suscipit volutpat.</div>
            </Col>
          ...
          <Row className="pt-3 pt-md-0">
            <Col md="6">
              ...
              <div className="text-body pt-0 pt-md-2">If your charity isn’t listed send us their info and we will add them to Contrib.</div>
            </Col>
            <Col md="6" className="pt-2 pt-md-0">
              <Form.Group>
