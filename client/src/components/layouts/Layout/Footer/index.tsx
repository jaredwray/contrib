    ...
    <footer className={clsx('d-print-none ps-0 p-4 ps-sm-4', styles.footer)}>
      <Container fluid>
        ...
        <Row className={clsx('py-4', styles.info)}>
          <Col className="p-0 px-md-4 text-headline">Auction your items quickly and hassle free.</Col>
        </Row>
        <Row>
          <Col md className="p-0 px-md-4 text-label text-all-cups">
            Copyright {new Date().getFullYear()} Contrib Inc.
          </Col>
        </Row>
        <Row>
          <Col md className="p-0 px-md-0 px-md-4">
