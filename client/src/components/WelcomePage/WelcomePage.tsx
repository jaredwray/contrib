              ...
              <Col lg="6" className="pt-5 pt-lg-0 pb-4 pb-lg-0">
                <div className="welcome-page-right-block p-4 p-md-5">
                  <div className="d-table w-100">
                    <a href="/" className="text-subhead btn btn-ochre btn-with-arrows d-table-cell align-middle w-100 welcome-page-create-btn">
                      Create an auction
                    </a>
                  </div>
                  <div className="text-label label-with-separator pt-4">Explore Contrib</div>
                  <a href="/profile" className="text-label text-all-cups d-block">View your account &gt;&gt;</a>
                  <a href="/" className="text-label text-all-cups d-block pt-4">View Auctions &gt;&gt;</a>
                </div>
              </Col>
            </Row>
          </Container>
